...
if opcion == 1
  ...
  %Se crea la funci�n delta para tomar muestras de la onda
...
endswitch
  ...
  t1=(0:(length(y)-1))/f_s;
  figure(2);
  subplot(1,1,1);plot(t1,y,'k');set(gca,'Xlim',[0 8]); set(gca,'XTick',(0:1:8)); axis([0 8 -1.1 1.1]); title('Señal codificada');xlabel('nT_s'); ylabel('x(nT_s)');
